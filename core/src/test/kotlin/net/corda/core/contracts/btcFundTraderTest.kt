...
//
//        val state = btcFundTrader.State("BTC", 1200, 10, notaryParty, fundParty, notary.public, btcAddr, id)
//
//        println(state)
//
...
//            btcFundTrader().transferFunds(builder, issuance.tx.outRef(0), newOwner.public)
